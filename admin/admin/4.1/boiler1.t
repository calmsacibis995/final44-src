...
.vs 18
.PP
THIS LICENSE AGREEMENT is made and entered into this ___________ day of
_____________ , 19____ , by and between THE REGENTS OF THE UNIVERSITY
OF CALIFORNIA, a California corporation and
___________________________________________
____________________________ , a _____________________ having its
principal office at _____________________________________ , hereinafter
``LICENSEE''.
.sp 2
.ps 10
.vs 12
...
Sharing System, Version 1.0 (hereinafter ``UNIX/32V''), and UNIX System
III (hereinafter ``SYSTEM-III''); and
.PP
...
Distribution to licensees who are also AT&T's licensees for either
UNIX/32V or SYSTEM-III; and
.PP
\fI WHEREAS, \fR LICENSEE warrants and represents that it is an AT&T
licensee for UNIX/32V or SYSTEM-III; and
.PP
...
shall terminate when LICENSEE's UNIX/32V or SYSTEM-III License terminates.
...
six hundred dollars ($600.00).  LICENSEE may obtain additional copies
and new releases
of the Fourth Berkeley Software Distribution which The Regents of
the University of California may make available by paying an additional
...
UNIX/32V and/or SYSTEM-III and has provided a copy of this license to
...
license from AT&T be modified, for example, to include additional CPU's
or to upgrade from a UNIX/32V license to a SYSTEM-III license, the
terms of the modified license will govern the use of the Fourth
Berkeley Software Distribution.
LICENSEE further agrees that the mark ``UNIX'' is a Trademark
of Bell Laboratories and that it may not be used in any fashion except by
the express written permission of AT&T.
.PP
...
by this Agreement provided that such duplication is acceptable to
AT&T.
.PP
...
.RS
.IP (a)
LICENSEE is permitted by AT&T to sublicense UNIX/32V or SYSTEM-III
software;
.IP (b)
...
LICENSEE's sublicensing of UNIX/32V or SYSTEM-III, whichever is
applicable;
.IP (c)
LICENSEE identifies to such third party all components based on or
derived from the Fourth Berkeley Software Distribution; and
.IP (d)
...
for their roles in its development.
.bp
.PP
\08.\ \ \fBLack of Warranty. \fR
The Fourth Berkeley Software Distribution is provided by The Regents
of the University of California on an ``As Is'' basis.
The Regents of the University of California does not warrant that the
...
free.
THE REGENTS OF THE UNIVERSITY OF CALIFORNIA MAKES
...
and agrees that The Regents of the University of California is
under no obligation to provide either maintenance services,
update services, notices of latent defects, nor correction
of defects for the Fourth Berkeley Software Distribution.
.PP
10.\ \ \fBPatent, Trade Secret and Copyright Infringement. \fR
If The Regents of the University of California gives formal written
...
of California, its successors, agents,
...
of California, with respect to any expense, claim, liability, loss or
...
The Regents of the University of California,
its agents, officers, and employees harmless in the
