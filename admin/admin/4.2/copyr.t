...
Bell Telephone Laboratories.
.sp
The documents ``A Portable Fortran 77 Compiler''
and ``Fsck \- The UNIX File System Check Program''
are modifications of earlier documents which
are copyrighted 1979 by
Bell Telephone Laboratories.
Holders of a UNIX\v'-4p'\s-2\fGTM\fP\s0\v'4p'/32V software
license are permitted to copy these documents, or any portion
of them, as necessary for licensed use of the software,
provided this copyright notice and statement of permission
are included.
.sp
