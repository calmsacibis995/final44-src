 ...
 * HISTORY
 * $Log:	ufs_alloc.c,v $
 * Revision 2.8.4.1  90/07/10  11:41:04  rvb
 * 	iPSC2:	same hack as multimax for block layout
 * 	[90/06/16            rvb]
 * 
...
#endif	defined (multimax) || defined (iPSC2)
norot:
	/*
