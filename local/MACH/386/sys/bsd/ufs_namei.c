 ...
 * HISTORY
 * $Log:	ufs_namei.c,v $
 * Revision 2.10.3.1  91/07/14  23:53:35  rvb
 * 	USER CONTRIBUTED: @sys support for -afs-nfs kernels
 * 	[91/06/27            mg32]
 * 
...
int namei_macros = 1;
char ATSYS[] = "@sys";
char SYSNAME[] = "i386_mach";
int SYSNAMELEN = sizeof(SYSNAME)-1;
#endif	i386
...
#ifdef	i386
	if (namei_macros && ndp->ni_dent.d_name[0] == '@') {
 		if (i == (sizeof ATSYS - 1) &&
