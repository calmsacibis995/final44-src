 ...
 * HISTORY
 * $Log:	sys.c,v $
 * Revision 2.1.1.2  90/03/22  18:00:03  rvb
 * 	Add code to calloc() to detect when we are clobbering our 
 * 	stack. [kupfer]
 * 
 * Revision 1.4  90/03/14  14:25:08  kupfer
 * I386e-- merge.
 * 
 * Revision 1.3  90/03/05  15:39:22  kupfer
 * Unshift CMU log entries.
 * 
 * Revision 2.1.1.1  90/02/09  17:28:19  rvb
 * 	Put into rcs tree.
 * 	[90/02/09            rvb]
 * 
 * Revision 1.1  89/09/12  12:14:21  dorr
 * Initial revision
 * 
 * Revision 2.5  89/03/09  21:17:08  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/26  14:35:50  gm0w
 * 	Changes for cleanup.
 * 
 ...
 * calloc(size) allocates and zeros a  buffer rounded to a NPG
 * boundary.
 ...
 *	Enclosed old file system code in new OLDFS conditional which is
 *	now usually off (but can be turned on manually when building
 *	programs to boot from 4.1 file systems).
 *	[ V5.1(F8) ]
 *
