...
#else	MACH_XP
extern void		vm_object_enter();
extern void		vm_object_setpager();
#endif	MACH_XP

extern void		vm_object_print();

extern port_t		vm_object_request_port();
