 ...
 * HISTORY
 * $Log:	init_main.c,v $
 * Revision 2.33  91/04/05  14:43:06  mbj
 * 	Always enable the UMODE_P_GID bit in the umodes, even in CMUCS
 * 	(finally).
 * 	[91/03/15            dlc]
 ...
 * 	[90/02/10            berman]
 * 
 * Revision 2.32  91/04/03  12:53:18  mbj
 * 	Flush jkdb.
 * 	[91/04/01            rvb]
 * 	Omron changes[sic]
 * 
 * Revision 2.31  90/09/08  12:02:27  mrt
...
#ifndef luna88k /* no interrupt_stack for Luna-88K */
...
main()
{
	...
	u.u_procp = p;
#if	defined(vax) || defined(ns32000) || defined(luna88k)
	/*
