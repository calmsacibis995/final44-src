 ...
 * HISTORY
 * $Log:	init_sysent.c,v $
 * Revision 2.24  91/06/25  17:46:25  mbj
 * 	Use indir() for the sun3 and mac2.
 * 
 * Revision 2.23  91/04/03  12:53:46  mbj
 * 	Omron changes[sic]
 * 
...
#endif	mips
#ifdef	luna
/* support for Omron-specific syscalls */
int	sysomron();
#endif	luna
...
#if	defined(sun3) || defined(sun4) || defined(mac2)
int	indir();		/* indirect system call */
#endif	defined(sun3) || defined(sun4) || defined(mac2)
/* END JUNK */
...
#else	defined(sun3) || defined(sun4) || defined(mac2)
...
#if	defined(multimax) || defined(ibmrt) || defined(balance) || defined(vax) || defined(sun3) || defined(i386) || defined(luna)
	syss(wait,0),			/*  84 = wait */
...
#undef	GENERIC
#ifdef	luna88k
	syss(sysomron,4),		/* 151 = sysomron functions (luna88k) */
#else	luna88k
	syss(nosys,0),			/* 151 */
#endif	luna88k
	syss(nosys,0),			/* 152 */
