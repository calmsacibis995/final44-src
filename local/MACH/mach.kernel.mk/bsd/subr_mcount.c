 ...
 * HISTORY
 * $Log:	subr_mcount.c,v $
 * Revision 2.9  91/04/03  13:00:12  mbj
 * 	Omron changes[sic]
 * 
 * Revision 2.8  91/04/02  11:04:40  mbj
...
#if	defined(vax) || defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(luna)
...
#else	multimax
#ifdef	luna
asm("mcount:	global	mcount");	/* For -p compiler option */
#endif	luna
mcount()
{
...
#ifdef  luna88k
	frame = follow_frame(0);
        selfpc = (char *)*(frame+1);
        frame = follow_frame(1);
        frompcindex = (unsigned short *)*(frame+1);
#endif  luna88k
#if	defined(sun)
	asm("	.text");		/* make sure we're in text space */
...
#if	defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(luna)
	return;
#endif	defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(luna)
...
asm(".data");
#endif	defined(vax) || defined(balance) || defined(sun)
#endif	defined(vax) || defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(luna)
#endif	!defined(mips)
#ifdef	mips
