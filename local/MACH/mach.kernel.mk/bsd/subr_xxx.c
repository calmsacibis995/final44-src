 ...
 * HISTORY
 * $Log:	subr_xxx.c,v $
 * Revision 2.12  91/04/03  13:00:58  mbj
 * 	Omron changes[sic]
 * 
 * Revision 2.11  91/04/02  11:05:26  mbj
...
#if	defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(mips) || defined(mac2) || defined(luna88k)
imin(a, b)
{
...
#endif	defined(ibmrt) || defined(ns32000) || defined(sun) || defined(i386) || defined(mips) || defined(mac2) || defined(luna88k)
...
#ifdef  luna88k
/* ffs is implemented in luna/locore.s */
#else  !luna88k
ffs(mask)
	register long mask;
{
