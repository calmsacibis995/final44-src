 ...
 * HISTORY
 * $Log:	lock.h,v $
 * Revision 2.8  91/04/03  13:07:22  mbj
 * 	Delete SIMPLE_LOCK_DEBUG
 * 	[91/04/02  18:31:32  rvb]
 * 
 * 	Omron changes[sic]
 * 
...
#ifdef	luna88k
	/*
	 *	Efficient luna88k implementation --
	 *	see field description below.
	 */
	simple_lock_data_t	interlock;
...
#if	!defined(ns32000) && !defined(luna88k)
...
#endif	!defined(ns32000) && !defined(luna88k)
};
