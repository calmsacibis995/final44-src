 ...
 * HISTORY
 * $Log:	thread.c,v $
 * Revision 2.24  91/08/30  09:38:12  berman
 * 	Add bug fix from David Black to unwedge threads.
 * 	[91/07/30  12:34:40  ern]
 * 
 * Revision 2.23  90/10/18  12:54:45  mrt
 * 	Fixed HW_FOOTPRINT code in thread_create.
 * 		Copied  a couple bug fixes in thread_policy from Mach 3.0
 * 	[90/10/16            mrt]
 * 
 * Revision 2.22  90/09/10  21:10:28  mrt
...
/*	thread_template.sched_pri (later - compute_priority) */
	...
	thread_template.messages_sent = 0;
	thread_template.messages_received = 0;
