 ...
 * HISTORY
 * $Log:	zalloc.c,v $
 * Revision 2.14  92/02/15  18:26:25  mja
 * 	Switch zone_ignore_overflow default from FALSE to TRUE since
 * 	this is deemed more appropriate for a production environment;
 * 	always print the diagnostic, though, so that we at least know
 * 	when overflows are happening.
 * 	[92/02/15  18:20:31  mja]
 * 
