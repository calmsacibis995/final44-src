 ...
 * HISTORY
 * $Log:	kern_return.h,v $
 * Revision 2.10  90/09/08  11:59:53  mrt
...
/* numbers 15-22 are aleady used by the Mach 3 kernel. Please
   coordinate with those sources before assigning new error codes */
