 ...
 * HISTORY
 * $Log:	machine.h,v $
 * Revision 2.20  91/08/29  22:35:15  berman
 * 	Added CPU_SUBTYPEs for more Sparcstations (II, ipc, slc, Hobbes).
 * 	[91/06/12            berman]
 * 
 * Revision 2.19  91/04/03  13:09:41  mbj
 * 	Omron changes[sic]
 * 
 * Revision 2.18  91/04/02  12:15:43  mbj
 * 	iPSC2: add subtype
 * 	[90/06/16            rvb]
 * 
...
#define CPU_SUBTYPE_iPSC2	((cpu_subtype_t) 3)
...
#ifdef luna88k
/*
 *      LUNA MC88100 subtypes.
 */

#define CPU_SUBTYPE_LUNA88K             ((cpu_subtype_t) 1)
#endif luna88k
