 ...
 * HISTORY
 * $Log:	cpu.map.h,v $
 * Revision 2.3  89/03/09  20:37:38  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  18:52:45  gm0w
 * 	Added new copyright and #ifndef <filename>_H_ around whole
 * 	file as part of kernel cleanup.
 * 	[89/02/13            jjc]
 * 
 */
/*	@(#)cpu.map.h 1.3 85/03/01 SMI	*/
 ...
 */
#define MEMPG_VIDEO	(0xFF000000 >> BYTES_PG_SHIFT)	/* Frame buffer */
#define MEMPG_M25VIDEO  (0x00100000 >> BYTES_PG_SHIFT)  /* FB in main mem */
