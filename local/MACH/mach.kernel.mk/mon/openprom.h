 ...
 * HISTORY
 * $Log:	openprom.h,v $
 * Revision 2.3  91/08/29  22:35:19  berman
 * 	Upgraded to newer release (SunOS 4.1.1) to work with newer ROMs.
 * 	[91/06/12            berman]
 * 
 * Revision 2.2  90/12/17  17:11:00  berman
 * 	Created from SunOS 4.0.3c for Sparcstation
 * 	[90/09/23            berman]
 * 
/*
...
#if	MACH
#define romp sunromp
extern struct sunromvec *sunromp;	/* as per the above discussion */
#else	MACH
