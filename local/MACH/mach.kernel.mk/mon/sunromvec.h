 ...
 * HISTORY
 * $Log:	sunromvec.h,v $
 * Revision 2.5  90/12/17  17:11:03  berman
 * 	Modified for SPARCstation I port.
 * 	[90/11/09            berman]
 * 
 * Revision 2.4  89/07/11  13:37:42  jjc
 * 	[89/07/05  20:17:55  jjc]
 * 
 *	Picked up new version for Sun 4.
 * 	[89/03/30            jjc]
 * 
 * Revision 2.3  89/03/09  20:38:13  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  18:53:12  gm0w
 ...
 *	Made file conditional on _SUNROMVEC.
 *	Note only sun seems to be defined by the sun compiler (not sun2 or sun3)
 *	so MONSTART does  not get defined - at least outside of the kernel.
 *
 *  4-Aug-86  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Changed name of rom pointer from "romp" to "sunromp" to
 *	avoid conflict with IBM PC RT "romp".
 *
 */
...
struct sunromvec {
  ...
  void               (**v_vector_cmd)();/* V2: Handler for the 'w' (vector)  *
                                        * command.                           */
#if defined(SUN4) || defined(sun4) || defined(sun4c)
...
#endif defined(SUN4) || defined(sun4) || defined(sun4c)
#ifdef sun4c
  ...
  int		     **v_shadowpteaddr;	 /* Physical addr of DVMA ptes      */
 ...
 *
 */
#if !defined(sun4c) && defined(SUN4) || defined(sun4)
#ifdef CACHE
#define sunromp ((struct sunromvec *) 0x00001000) /* Used when running the   *
                                                * firmware out of the cache. */
#else CACHE
#define sunromp ((struct sunromvec *) 0xFFE81000) /* Used when running the  *
						   * firmware out of ROM.   */
#endif CACHE
#else !defined(sun4c) && defined(SUN4) || defined(sun4)
#ifdef sun4c
#define romp sunromp
extern struct sunromvec *sunromp;
#else sun4c
/*
 * Note that the value of "romp" will be 
 ...
 */
#define sunromp ((struct sunromvec *) 0x0FEF0000)
#endif sun4c
#endif !defined(sun4c) && defined(SUN4) || defined(sun4)
...
#if defined(SUN4) || defined(sun4) || defined(SUN4C) || defined(sun4c)
#define MONSTART 0xFFD00000
#define MONEND   0xFFF00000
#endif defined(SUN4) || defined(sun4) || defined(SUN4C) || defined(sun4c)
#endif	OPENPROMS
...
#if defined(SUN4C) || defined(sun4c)
#define MAINMEM_MAP_SIZE 0x00400000
#define DVMA_MAP_SIZE    0x00080000
#endif  defined(SUN4C) || defined(sun4c) 
