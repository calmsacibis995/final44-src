...
/*
 * HISTORY
 * $Log:	mem_rop_impl_ops.h,v $
 * Revision 2.4  89/03/09  20:56:20  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  19:11:35  gm0w
 * 	Added new copyright and #ifndef <filename>_H_ around whole
 * 	file as part of kernel cleanup.
 * 	[89/02/13            jjc]
 * 
 */
/* @(#)mem_rop_impl_ops.h 1.2 86/10/08 SMI */

/*
 * Copyright 1986 by Sun Microsystems,  Inc.
 */

#ifndef	MEM_ROP_IMPL_OPS_H_
#define MEM_ROP_IMPL_OPS_H_
...
#define OP_mfgen5(m,c)	(m)
#define OP_mfmsk5(m)	(m)
#define OP_mfill5(d,m,k) ((d) ^ (k))
