 ...
 * HISTORY
 * $Log:	xdr_mbuf.c,v $
 * Revision 2.4  89/03/09  21:00:37  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  19:16:21  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.2  89/01/18  01:06:43  jsb
 * 	Include file references.
 * 	[89/01/17  14:25:31  jsb]
 * 
 */
/* @(#)xdr_mbuf.c	1.1 87/06/19 3.2/4.3NFSSRC */
/* @(#)xdr_mbuf.c	1.2 86/10/28 NFSSRC */
#ifndef	lint
static char sccsid[] = "@(#)xdr_mbuf.c 1.1 86/09/24 Copyr 1984 Sun Micro";
#endif
