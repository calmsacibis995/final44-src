 ...
 * HISTORY
 * $Log:	config.h,v $
 * Revision 2.14  92/02/11  17:58:48  mja
 * 	     For luna, added changed needed to build a miniroot.
 * 	[92/01/31            jfriedl]
 * 
 * Revision 2.13  91/04/04  01:25:47  mbj
 * 	Removed luna88k conditionals from struct idlst id_span field.
 * 
 * Revision 2.12  91/04/03  13:10:53  mbj
 * 	Omron changes[sic]
 * 
 * Revision 2.11  90/12/17  19:31:11  berman
 * 	Flushed struct vlist from SunOS.
 * 	[90/12/17            berman]
 * 	Added MACHINE_SUN4C definition and sun config structs.
 * 	[90/02/12            parker]
 * 
...
struct	idlst {
	...
	short	id_span;	/* luna88k ISI: distance to next vector */
};
...
#define MACHINE_SUN4C	14
#define MACHINE_LUNA88K	15
