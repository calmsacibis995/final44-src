...
# HISTORY
# $Log:	machtree.sh,v $
# Revision 2.17  91/05/24  15:42:12  mbj
# 	Filled out directory and link creation cases for mmax, pmax, and sun4.
# 	[91/05/05            mbj]
# 
# Revision 2.16  91/04/10  22:56:21  mbj
# 	typo machi386 -> mach/i386
# 	[91/04/10            rvb]
# 
# Revision 2.15  91/04/10  15:59:30  mbj
# 	Add i386 and luna88k to MACHINE heirarchy.
# 	[91/04/06            rvb]
# 
...
if [ "$TreeInAFS" ]; then
	...
	if [ ! -d OBJS/sun4_mach ]; then
		if [ ! "$Quiet" ]; then echo "[ creating OBJS/sun4_mach ]"; fi
		rm -rf OBJS/sun4_mach
		mkdir OBJS/sun4_mach
	fi
	...
	if [ ! -d OBJS/mmax_mach ]; then
		if [ ! "$Quiet" ]; then echo "[ creating OBJS/mmax_mach ]"; fi
		rm -rf OBJS/mmax_mach
		mkdir OBJS/mmax_mach
	fi
	...
	if [ ! -d OBJS/luna88k_mach ]; then
		if [ ! "$Quiet" ]; then echo "[ creating OBJS/luna88k_mach ]"; fi
		rm -rf OBJS/luna88k_mach
		mkdir OBJS/luna88k_mach
	fi
fi
...
if [ "$TreeInAFS" ] && [ ! -d MACHINE ]; then
	...
	ln -s ../sun4 MACHINE/sun4_mach
	ln -s ../mmax MACHINE/mmax_mach
	ln -s ../mips MACHINE/pmax_mach
	ln -s ../i386 MACHINE/i386_mach
	ln -s ../luna88k MACHINE/luna88k_mach
	...
	ln -s ../../mach/sun4 MACHINE/mach/sun4_mach
	ln -s ../../mach/mmax MACHINE/mach/mmax_mach
	ln -s ../../mach/mips MACHINE/mach/pmax_mach
	ln -s ../../mach/i386 MACHINE/mach/i386_mach
	ln -s ../../mach/luna88k MACHINE/mach/luna88k_mach
	...
	ln -s ../../mach_debug/sun4 MACHINE/mach_debug/sun4_mach
	ln -s ../../mach_debug/mmax MACHINE/mach_debug/mmax_mach
	ln -s ../../mach_debug/mips MACHINE/mach_debug/pmax_mach
	ln -s ../../mach_debug/i386 MACHINE/mach_debug/i386_mach
	ln -s ../../mach_debug/luna88k MACHINE/mach_debug/luna88k_mach
fi
...
if [ ! "$TreeInAFS" ]; then
	case `/etc/machine` in
		...
		SUN3) machine_dir="sun3";;

		SUN4) machine_dir="sun4";;

		MMAX) machine_dir="mmax";;

		PMAX) machine_dir="mips";;

		I386) machine_dir="i386";;
		AT386) machine_dir="i386";;

		LUNA88K) machine_dir="luna88k";;
