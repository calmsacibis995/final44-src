 ...
 * HISTORY
 * $Log:	asm_linkage.h,v $
 * Revision 2.4  89/03/09  21:31:46  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  19:32:57  gm0w
 ...
 *	Changed interrupt-stack tests again, for MACH (back in
 *	original relationship).
 *
 * 20-Aug-86  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Changed tests to see whether on interrupt stack because
 *	moved u-area.
 *
 */
