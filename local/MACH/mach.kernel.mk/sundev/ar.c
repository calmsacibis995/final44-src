 ...
 * HISTORY
 * $Log:	ar.c,v $
 * Revision 2.4  89/07/11  17:37:26  jjc
 * 	Changed to include machine dependent header files from machine/ not sun3/
 * 	because the Sun 4 uses this device driver too.
 * 	[89/07/06  16:45:48  jjc]
 * 
 * Revision 2.3  89/03/09  21:39:44  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  19:49:05  gm0w
 * 	Changes for cleanup.
 * 
 */
#ifndef	lint
static	char sccsid[] = "@(#)ar.c 1.1 86/02/03 Copyr 1985 Sun Micro";
#endif
