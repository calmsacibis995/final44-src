...
/*
 * If both FPA_USED and FPA_CTX_SAVED are set in pcb_fpa_flags,
 * then the FPA was being used and it's FPA context was stolen
 * by a thread who was nice enough to save the old thread's context
 * in the pcb.
 */
#define FPA_USED	0x100	/* FPA has been used */
#define FPA_CTX_SAVED	0x200	/* FPA context is saved in pcb */
