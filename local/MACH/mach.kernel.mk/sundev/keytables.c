 ...
 * HISTORY
 * $Log:	keytables.c,v $
 * Revision 2.4  90/12/17  17:21:04  berman
 * 	Updated keytables from SunOS 4.0.3c for Sparcstation.
 * 	[90/09/10            berman]
 * 
 * Revision 2.3  89/03/09  21:43:03  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  19:52:18  gm0w
 * 	Changes for cleanup.
 * 
 */
#ifndef	lint
static	char sccsid[] = "@(#)keytables.c 1.16 89/02/21 Copyr 1987 Sun Micro";
#endif
...
/* Unshifted keyboard table for Sun-4 keyboard */

static struct keymap keytab_s4_lc = {
/*  0 */	HOLE,	BUCKYBITS+SYSTEMBIT,
				HOLE,	LF(2),	HOLE,	TF(1),	TF(2),	TF(10),
/*  8 */	TF(3), 	TF(11),	TF(4),	TF(12),	TF(5),	HOLE,	TF(6),	HOLE,
/* 16 */	TF(7),	TF(8),	TF(9),	ALT,	HOLE,	RF(1),	RF(2),	RF(3),
/* 24 */	HOLE, 	LF(3), 	LF(4),	HOLE,	HOLE,	c('['),	'1',	'2',
/* 32 */	'3',	'4',	'5',	'6',	'7',	'8',	'9',	'0',
/* 40 */	'-',	'=',	'`',	'\b',	HOLE,	RF(4),	RF(5),	RF(6),
...
/* 88 */	'\\',	'\r',	BF(11),	STRING+LEFTARROW,
						RF(11),	STRING+RIGHTARROW,
								BF(8),	LF(9),
/* 96 */	HOLE,	LF(10),	BF(16),	SHIFTKEYS+LEFTSHIFT,
						'z',	'x',	'c',	'v',
/*104 */	'b',	'n',	'm',	',',	'.',	'/',	SHIFTKEYS+RIGHTSHIFT,
									'\n',
/*112 */	RF(13),	STRING+DOWNARROW,
...
/* Shifted keyboard table for Sun-4 keyboard */
...
/* Caps Locked keyboard table for Sun-4 keyboard */
...
/* Controlled keyboard table for Sun-4 keyboard */
...
/* "Key Up" keyboard table for Sun-4 keyboard */
...
/* Index to keymaps for Sun-4 keyboard */
...
/* Unshifted keyboard table for VT220 style special keyboard KB_VT220 */

static struct keymap keytab_k220_lc = {
/*  0 */	HOLE,	LF(1),	'4',	LF(2),	'5',	TF(1),	TF(2),	'6',
/*  8 */	TF(3), 	',',	TF(4),	HOLE,	TF(5),	'\r',   TF(6),	HOLE,
/* 16 */	TF(7),	TF(8),	TF(9),	BUCKYBITS+METABIT,
						'<',	RF(1),	RF(2),	RF(3),
/* 24 */	'1', 	LF(3), 	LF(4),	HOLE,	HOLE,	c('['),	'1',	'2',
/* 32 */	'3',	'4',	'5',	'6',	'7',	'8',	'9',	'0',
/* 40 */	'-',	'=',	'`',	'\b',	HOLE,	RF(4),	RF(5),	RF(6),
/* 48 */	HOLE,	LF(5),	HOLE,	LF(6),	HOLE,	'\t',	'q',	'w',
/* 56 */	'e',	'r',	't',	'y',	'u',	'i',	'o',	'p',
...
/*104 */	'b',	'n',	'm',	',',	'.',	'/',	SHIFTKEYS+RIGHTSHIFT,
									'\n',
/*112 */	RF(13),	STRING+DOWNARROW,
				'8',	'9',	'2',	'3',	LF(16),	SHIFTKEYS+CAPSLOCK,
/*120 */	'7',	' ',	'-',	 '.',	'0',	HOLE,	ERROR,	IDLE,
};

/* Shifted keyboard table for VT220 style special keyboard KB_VT220 */

static struct keymap keytab_k220_uc = {
/*  0 */	HOLE,	LF(1),	BF(3),	LF(2),	BF(4),	TF(1),	TF(2),	BF(5),
/*  8 */	TF(3), 	BF(6),	TF(4),	HOLE,	TF(5),	'\r',	TF(6),	HOLE,
/* 16 */	TF(7),	TF(8),	TF(9),	BUCKYBITS+METABIT,
						'>',	RF(1),	RF(2),	RF(3),
/* 24 */	BF(7), 	LF(3), 	LF(4),	HOLE,	HOLE,	c('['),	'!',    '@',
/* 32 */	'#',	'$',	'%',	'^',	'&',	'*',	'(',	')',
/* 40 */	'_',	'+',	'~',	'\b',	HOLE,	RF(4),	RF(5),	RF(6),
/* 48 */	HOLE,	LF(5),	HOLE,	LF(6),	HOLE,	'\t',	'Q',	'W',
/* 56 */	'E',	'R',	'T',	'Y',	'U',	'I',	'O',	'P',
...
/*104 */	'B',	'N',	'M',	',',	'.',	'?',	SHIFTKEYS+RIGHTSHIFT,
									'\n',
/*112 */	RF(13),	STRING+DOWNARROW,
				RF(15),	RF(16),	BF(8),	BF(9),	TF(2),	SHIFTKEYS+CAPSLOCK,
/*120 */	BF(1),	' ',	BF(2),	BF(12),	BF(11),	HOLE,	ERROR,	IDLE,
};


/* Caps Locked keyboard table for Vt220 style special keyboard KB_VT220 */

static struct keymap keytab_k220_cl = {
/*  0 */	HOLE,	LF(1),	'4',	LF(2),	'5',	TF(1),	TF(2),	'6',
/*  8 */	TF(3), 	',',	TF(4),	HOLE,	TF(5),	'\r',	TF(6),	HOLE,
/* 16 */	TF(7),	TF(8),	TF(9),	BUCKYBITS+METABIT,
						'<',	RF(1),	RF(2),	RF(3),
...
/*104 */	'B',	'N',	'M',	',',	'.',	'/',	SHIFTKEYS+RIGHTSHIFT,
									'\n',
/*112 */	RF(13),	STRING+DOWNARROW,
				'8',	'9',	'2',	'3',	TF(2),	SHIFTKEYS+CAPSLOCK,
/*120 */	'7',	' ',	'-',	 '.',	'0',	HOLE,	ERROR,	IDLE,
};

/* Controlled keyboard table for VT220 style special keyboard KB_VT220 */

static struct keymap keytab_k220_ct = {
/*  0 */	HOLE,	LF(1),	BF(3),	LF(2),	BF(4),	TF(1),	TF(2),	BF(5),
/*  8 */	TF(3), 	BF(6),	TF(4),	HOLE,	TF(5),	'\r',	TF(6),	HOLE,
/* 16 */	TF(7),	TF(8),	TF(9),	BUCKYBITS+METABIT,
						'<',	RF(1),	RF(2),	RF(3),
/* 24 */	BF(7), 	LF(3), 	LF(4),	HOLE,	HOLE,	c('['),	'1',	c('@'),
/* 32 */	'3',	'4',	'5',	c('^'),	'7',	'8',	'9',	'0',
/* 40 */	c('_'),	'=',	c('^'),	'\b',	HOLE,	RF(4),	RF(5),	RF(6),
/* 48 */	HOLE,	LF(5),	HOLE,	LF(6),	HOLE,	'\t',   c('q'),	c('w'),
/* 56 */	c('e'),	c('r'),	c('t'),	c('y'),	c('u'),	c('i'),	c('o'),	c('p'),
...
/*112 */	RF(13),	STRING+DOWNARROW,
				RF(15),	RF(16),	BF(8),	BF(9),	TF(2),	SHIFTKEYS+CAPSLOCK,
/*120 */	BF(1),	c(' '),	BF(2),	BF(12),	BF(11),	HOLE,	ERROR,	IDLE,
};

/* "Key Up" keyboard table for VT220 style special keyboard KB_VT220 */

static struct keymap keytab_k220_up = {
/*  0 */	HOLE,	BUCKYBITS+SYSTEMBIT,
				HOLE,	OOPS,	HOLE,	OOPS,	OOPS,	HOLE,
/*  8 */	OOPS, 	HOLE, 	OOPS,	HOLE,	OOPS,	HOLE,	OOPS,	HOLE,
/* 16 */	OOPS, 	OOPS, 	OOPS,	BUCKYBITS+METABIT,
						HOLE,	OOPS,	OOPS,	NOP,
/* 24 */	HOLE, 	OOPS, 	OOPS,	HOLE,	HOLE,	NOP,	NOP,	NOP,
/* 32 */	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,	NOP,
/* 40 */	NOP,	NOP,	NOP,	NOP,	HOLE,	OOPS,	OOPS,	NOP,
...
/* Index to keymaps for VT220 style special keyboard KB_VT220 */
static struct keyboard keyindex_k220 = {
	&keytab_k220_lc,
	&keytab_k220_uc,
	&keytab_k220_cl,
	&keytab_k220_ct,
