 ...
 * HISTORY
 * $Log:	ropc.c,v $
 * Revision 2.4  89/07/11  17:39:14  jjc
 * 	Changed to include machine dependent header files from machine/ not sun3/ because the Sun 4 uses this device driver too.
 * 	[89/07/06  16:54:29  jjc]
 * 
 * Revision 2.3  89/03/09  21:44:25  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  19:53:34  gm0w
 * 	Changes for cleanup.
 * 
 */
#ifndef	lint
static	char sccsid[] = "@(#)ropc.c 1.1 86/02/03 Copyr 1983 Sun Micro";
#endif
