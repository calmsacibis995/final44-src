 ...
 * HISTORY
 * $Log:	sf.c,v $
 * Revision 2.6  89/07/11  17:39:44  jjc
 * 	Changed to include machine dependent header files from machine/ not sun3/ because the Sun 4 uses this device driver too.
 * 	[89/07/06  16:55:13  jjc]
 * 
 * Revision 2.5  89/03/09  21:45:38  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/25  19:54:47  gm0w
 * 	Added new copyright and fixed includes as part of kernel
 * 	cleanup.
 * 	[89/02/10            jjc]
 * 
 * Revision 2.3  88/12/07  17:21:46  mikeg
 * 	Entered new sf driver from SunOS 3.5 into the Mach
 * 	source tree.
 * 	[88/12/01  14:28:55  mikeg]
 * 
 * 15-Aug-88  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Picked up SunOS 3.5 version and changed to use 
 *	sun_kmem_{alloc,free}().
 *
 */
/*	@(#)sf.c 1.1 87/12/21 SMI	*/
