 ...
 * HISTORY
 * $Log:	sireg.h,v $
 * Revision 2.5  89/03/09  21:46:14  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/25  19:55:17  gm0w
 * 	Added new copyright and fixed includes as part of kernel
 * 	cleanup.
 * 	[89/02/10            jjc]
 * 
 * Revision 2.3  88/12/07  17:22:56  mikeg
 * 	Entered new version of this file from SuunOS 3.5 into
 * 	Mach kernel source tree.
 * 	[88/12/01  14:43:16  mikeg]
 * 
 * 14-Aug-88  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Upgraded to SunOS 3.5 with help from Jon Hale at Mt. Xinu.
 *	Changed DVMA_OFFSET to be relative to 0x0F000000 only on
 *	Sun 3 and put under "#if MACH" instead of "#if CS_GENERIC".
 *
 * 19-Mar-87  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Changed definition of DVMA_OFFSET to be relative to 0F000000
 *	instead of KERNELBASE, so the kernel can be moved without
 *	breaking the SCSI controller.
 *	[ V5.1(F8) ]
 *
 */
/* 
 ...
 * the terms and conditions for use and redistribution.
 */
/* @(#)sireg.h       1.1 87/12/21 Copyr 1987 Sun Micro */
...
#define PHASE_CMD_CPLT		0x86	/* for driver use only */
...
#ifdef	MACH
#ifdef	sun3
#define DVMA_OFFSET	(int)(DVMA - (char *)0x0F000000)
#else	sun3
