 ...
 * HISTORY
 * $Log:	vp.c,v $
 * Revision 2.4  89/07/11  17:40:38  jjc
 * 	Changed to include machine dependent header files from machine/ not sun3/ because the Sun 4 uses this device driver too.
 * 	[89/07/06  16:56:39  jjc]
 * 
 * Revision 2.3  89/03/09  21:48:00  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  19:57:11  gm0w
 * 	Changes for cleanup.
 * 
 */
#ifndef	lint
static	char sccsid[] = "@(#)vp.c 1.1 86/02/03 Copyr 1985 Sun Micro";
#endif
