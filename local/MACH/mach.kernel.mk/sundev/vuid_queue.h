 ...
 * HISTORY
 * $Log:	vuid_queue.h,v $
 * Revision 2.3  89/03/09  21:48:45  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  19:58:02  gm0w
 * 	Changes for cleanup.
 * 
 */
/*	@(#)vuid_queue.h 1.1 86/02/03 SMI	*/
...
extern	void vq_initialize();	/* (Vuid_queue *vq, caddr_t data, int bytes)
