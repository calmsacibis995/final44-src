 ...
 * HISTORY
 * $Log:	vuid_store.c,v $
 * Revision 2.4  89/03/09  21:48:51  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  19:58:17  gm0w
 ...
 *	Modified to use Mach "kmem_alloc" and "kmem_free".
 */

#ifndef	lint
static	char sccsid[] = "@(#)vuid_store.c 1.1 86/02/03 Copyr 1985 Sun Micro";
#endif
...
#define vuid_alloc(bytes)	sun_kmem_alloc((bytes))
#define vuid_free(ptr, bytes)	sun_kmem_free((ptr), (bytes))
#else	MACH
