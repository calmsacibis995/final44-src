 ...
 * HISTORY
 * $Log:	xt.c,v $
 * Revision 2.6  89/07/11  17:40:49  jjc
 * 	Changed to include machine dependent header files from machine/ not sun3/ because the Sun 4 uses this device driver too.
 * 	[89/07/06  16:57:01  jjc]
 * 
 * Revision 2.5  89/03/10  01:30:47  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/03/04  17:11:06  rpd
 * 	We missed removing an #endif CMU
 * 	[89/03/01            rvb]
 * 
 * Revision 2.3  89/02/25  19:58:49  gm0w
 * 	Added new copyright and fixed includes as part of kernel
 * 	cleanup.
 * 	[89/02/10            jjc]
 * 
 * Revision 2.2  88/08/22  21:32:17  mja
 * 	SunOS version 1.4
 * 	[88/08/08  14:15:18  mja]
 * 
 */
