 ...
 * HISTORY
 * $Log:	zsreg.h,v $
 * Revision 2.6  90/12/17  17:21:30  berman
 * 	Merged changes from SunOS 4.0.3c for Sparcstation and sun386.
 * 	[90/09/13            berman]
 * 
 * Revision 2.5  89/10/15  02:06:49  rpd
 * 	Minor cleanups.
 * 
 * Revision 2.4  89/07/11  17:29:05  jjc
 * 	Picked up SunOS 3.5 version.
 * 	[89/07/05  20:51:59  jjc]
 * 
 * 09-Aug-88  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Changed "#ifndef LOCORE" to  "#if !defined(LOCORE) && 
 *	!defined(ASSEMBLER)".
 *
 */

/*	@(#)zsreg.h 1.1 87/12/21 SMI */
