 ...
 * HISTORY
 * $Log:	if_ec.c,v $
 * Revision 2.4  90/02/20  19:12:22  mrt
 * 	Removed extraneous third argument to if_set_addr
 * 	[90/02/20            mrt]
 * 
 * Revision 2.3  89/03/09  21:51:18  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  20:01:47  gm0w
 * 	Changes for cleanup.
 * 
 */
#ifndef	lint
static  char sccsid[] = "@(#)if_ec.c 1.1 86/02/03 Copyr 1985 Sun Micro";
#endif
	...
	dev_t dev;
{
	...
	*(u_short *)(addr->ec_tbuf) = off;
	...
	copy_from_mbufs((u_char *)(addr->ec_tbuf + off), m);
