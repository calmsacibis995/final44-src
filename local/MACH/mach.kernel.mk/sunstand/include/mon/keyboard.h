 ...
 * HISTORY
 * $Log:	keyboard.h,v $
 * Revision 2.2  89/07/11  23:24:35  jjc
 * 	     Picked up from SunOS 4.0.
 * 	[89/07/03            jjc]
 * 
 */
/*      @(#)keyboard.h 1.1 86/10/07 SMI; from UCB X.X XX/XX/XX       */
...
#define ABORTKEY1       1               /* First key of abort seq - ERASE EOF */#define ABORTKEY2       77              /* 2nd key of abort seq - "A" */
#endif KEYBKL
...
#endif KEYBVT
#endif sun2
#if !defined(KEYBVT) && !defined(KEYBKL)
