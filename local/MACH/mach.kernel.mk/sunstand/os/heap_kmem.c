 ...
 * HISTORY
 * $Log:	heap_kmem.c,v $
 * Revision 2.2  89/07/12  01:11:21  jjc
 * 	Defined morecore() to be kmem_morecore() because it clashes
 * 	with C library version of morecore() when linking the boot
 * 	program.
 * 	[89/06/04            jjc]
 * 
 */
#ifndef lint
static        char sccsid[] = "@(#)heap_kmem.c 1.8 88/02/08 Copyr 1987 Sun Micro";
#endif
