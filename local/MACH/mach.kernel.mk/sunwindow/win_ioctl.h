 ...
 * HISTORY
 * $Log:	win_ioctl.h,v $
 * Revision 2.5  89/03/09  21:59:18  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/25  20:06:41  gm0w
 * 	Added new copyright as part of kernel cleanup.
 * 	[89/02/12            jjc]
 * 
 * 29-Dec-87  Robert Baron (rvb) at Carnegie-Mellon University
 *	struct winscreenposdummy had been defined incorrectly without
 *	the ";" after the terminating the "int" statement.
 */
