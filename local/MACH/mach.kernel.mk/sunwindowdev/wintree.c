 ...
 * HISTORY
 * $Log:	wintree.c,v $
 * Revision 2.5  89/03/09  22:01:27  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/25  20:08:43  gm0w
 * 	Added new copyright and fixed includes as part of kernel cleanup.
 * 	[89/02/12            jjc]
 * 
 * Revision 2.3  88/10/18  00:36:20  mwyoung
 * 	a.b = a.c = 0; Seems to freek out gcc when b and c are short's.
 * 	[88/10/13            rvb]
 * 
 */
#ifndef	lint
	...
	register struct	rectlist *rlaffected; /* Self relative */
{
	...
	if (winthis->w_link[WL_PARENT] == NULL) {
		...
		rparent.r_left = 0; rparent.r_top = 0;
		/*
