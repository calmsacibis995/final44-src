 ...
 * HISTORY
 * $Log:	wintree.h,v $
 * Revision 2.4  89/03/09  22:01:36  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  20:08:51  gm0w
 ...
 *	Include task.h before proc.h to avoid having cpp give ccom a
 *	pathname longer than it can handle (ie. 100 characters).
 *
 */
...
#include <sys/proc.h>
#include <sys/conf.h>
#include <sys/ioctl.h>	/* h/ttychars h/ttydev sgtty */
#include <sys/tty.h>	/* h/ttychars h/ttydev */
#include <sys/map.h>
#include <sys/clist.h>
