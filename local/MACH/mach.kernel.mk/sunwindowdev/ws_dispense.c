 ...
 * HISTORY
 * $Log:	ws_dispense.c,v $
 * Revision 2.6  89/03/09  22:01:53  rpd
 * 	More cleanup.
 * 
 * Revision 2.5  89/02/25  20:09:13  gm0w
 * 	Added new copyright and fixed includes as part of kernel cleanup.
 * 	[89/02/12            jjc]
 * 
 * Revision 2.4  88/10/18  00:36:45  mwyoung
 * 	Forward declarations of static's to make gcc happy:
 * 		static ws_dtop_mutex_locked();
 * 	[88/10/14            rvb]
 * 
 * Revision 2.3  88/08/24  02:22:05  mwyoung
 * 	Corrected include file references.
 * 	[88/08/22            mwyoung]
 * 
 *
 * 15-Mar-88  Jonathan J. Chew (jjc) at Carnegie-Mellon University
 *	Changed call to sleep() with PCATCH argument to call to 
 *	tsleep() instead.
 *
 */
#ifndef	lint
...
#ifdef	MACH
			if (tsleep((caddr_t)&ws->ws_flags, LOCKPRI, 0) == TS_SIG) {
#else	MACH
