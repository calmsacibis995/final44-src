 ...
 * HISTORY
 * $Log:	ioctl.h,v $
 * Revision 2.19  91/10/31  22:24:49  mja
 * 	Add TIOCGSLAVE.
 * 	[91/10/30  17:59:14  mja]
 * 
 * Revision 2.18  91/04/03  13:15:16  mbj
 * 	Omron changes[sic]
 * 
...
#ifdef	__STDC__
#define TIOCGSLAVE	_IOR ('t', 246, int)
#else
#define TIOCGSLAVE	_IOR (t, 246, int)
#endif
...
#ifdef	luna88k
#define	TIOCTWOSB	_IO('t', 101)		/* set two stop bits */
#define	TIOCONESB	_IO('t', 100)		/* set one stop bit */
#define	TIOCCONS	_IO('t', 36)		/* set console window(normal) */
#define	TIOCSETCONS	_IO('t', 39)		/* set console window */
#define	TIOCRESETCONS	_IO('t', 40)		/* reset console window */
#endif	luna88k
...
#define DIOCDISC	_IO(d, 0)			/* get disk part */
#define DIOCNODISC	_IO(d, 1)			/* get disk part */
#define DIOCGGEO	_IOR(d, 2, struct scdunit)	/* get disk part */
#endif	luna
