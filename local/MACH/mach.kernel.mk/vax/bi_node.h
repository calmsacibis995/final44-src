 ...
 * HISTORY
 * $Log:	bi_node.h,v $
 * Revision 2.5  89/03/09  22:12:51  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/25  20:11:43  gm0w
 * 	Changes for cleanup.
 * 
...
#define BI_ADDR(i)	((caddr_t)(0x20000000 + 0x2000000*i))
#define BI_NODE_LOCAL	((vm_offset_t)0x20800000)
...
#ifdef	KERNEL
struct bi_node *bi_node;		/* maps all possible bi nodes */
struct bi_node *bi_node_local;		/* maps local bi node */
#endif	KERNEL
#endif	ASSEMBLER
