 ...
 * HISTORY
 * $Log:	kdbdefine.h,v $
 * Revision 2.4  89/03/09  22:17:17  rpd
 * 	More cleanup.
 * 
 * Revision 2.3  89/02/25  20:22:25  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.2  88/08/10  10:27:13  rvb
 * 	We will now use setjmp/longjmp vs setexit/reset for the
 * 	kernel code.  This is so we can save/restore the jmpbuf.
 * 
 */
...
#define setexit() (setjmp(&kdb_save) ? kdb_setjmp_val : 0)
#define reset(x)  (kdb_setjmp_val = x, longjmp(&kdb_save))
