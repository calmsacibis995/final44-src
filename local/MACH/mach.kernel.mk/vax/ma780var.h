 ...
 * HISTORY
 * $Log:	ma780var.h,v $
 * Revision 2.3  89/03/09  22:18:33  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  20:24:51  gm0w
 * 	Changes for cleanup.
 * 
...
u_long MPISTAT_to[], MPISTAT_from[], MPIR_to[], MPIR_from[] ;
u_long MPESTAT_to[], MPESTAT_from[], MPEN_to[], MPEN_from[] ;
#endif	NMACH_MPM > 0
#endif
