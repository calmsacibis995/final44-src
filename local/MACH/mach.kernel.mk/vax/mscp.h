 ...
 * HISTORY
 * $Log:	mscp.h,v $
 * Revision 2.3  89/03/09  22:19:14  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/25  20:26:02  gm0w
 * 	Changes for cleanup.
 * 
 * 17-Sep-87  Mike Accetta (mja) at Carnegie-Mellon University
 *	NET_UDA: hooked in new definitions from Chris Torek at UMD.
 *	[ V5.1(XF16) ]
 *
 ...
 *	CS_VAXM:  Added event sub-code and RQDX1 map register base (a
 *	la ULTRIX).
 *	[V1(1)]
 *
 */
 ...
 *  Event Sub-codes
 */
#define M_DT_FEM	0010	/* Block contains Force Error modifier */
#define M_DT_IVHDR	0110	/* Invalid Header */
#define M_DT_DST	0150	/* Data Sync not found (Data Sync Timeout) */
#define M_DT_CECCFLD	0210	/* Correctable error in ECC field */
#define M_DT_UCECC	0350	/* Uncorrectable ECC Error */
#define M_DT_1SYMECC	0410	/* One Symbol ECC Error   (correctable) */
#define M_DT_2SYMECC	0450	/* Two Symbol ECC Error   (correctable) */
#define M_DT_3SYMECC	0510	/* Three Symbol ECC Error (correctable) */
#define M_DT_4SYMECC	0550	/* Four Symbol ECC Error  (correctable) */
#define M_DT_5SYMECC	0610	/* Five Symbol ECC Error  (correctable) */
#define M_DT_6SYMECC	0650	/* Six Symbol ECC Error   (correctable) */
#define M_DT_7SYMECC	0710	/* Seven Symbol ECC Error (correctable) */
#define M_DT_8SYMECC	0750	/* Eight Symbol ECC Error (correctable) */
#define M_OL_DUPUNUM	0203	/* Duplicate Unit Number */
#endif	VAX630 || VAX1
...
#if	VAX820 || VAX1
#define mscp_mapbase	mscp_un.mscp_generic.Mscp_xxx2[0]
#endif	VAX820 || VAX1
