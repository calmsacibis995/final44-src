 ...
 * HISTORY
 * $Log:	nexus.h,v $
 * Revision 2.5  89/03/09  22:19:52  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/25  20:26:30  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.3  88/08/24  03:01:51  mwyoung
 * 	Corrected include file references.
 * 	[88/08/22  19:00:32  mwyoung]
 * 
...
#if	VAX650
#define NNEX650	5
#define NEX650	((struct nexus *)0x20080000)
#endif
#if	VAX630
/*
 *  Pretend that we have 4 pseudo-nexus spaces so that the first
 *  can be used for the BDR and memory system registers which
 *  are found there and the fourth can be used for the Q22-Bus
 *  mapping registers.
 */
#define NNEX630	5
#define NEX630	((struct nexus *)0x20080000)
#endif
#if	VAX1
#define NNEX1	1
#define NEX1	((struct nexus *)0x20000000)
#endif	VAX1
...
#endif	CMUCS
#define NEX_MEMCTL	0xfd		/* Mayfair memory controller */
#define NEX_CACR_BDR	0xfe		/* Mayfair CACR and BDR */
#define NEX_BDRMEM	0xff		/* MicroVax-2 BDR and memory system */
