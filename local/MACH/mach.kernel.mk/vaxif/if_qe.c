 ...
 * HISTORY
 * $Log:	if_qe.c,v $
 * Revision 2.11  89/03/09  22:27:49  rpd
 * 	More cleanup.
 * 
 * Revision 2.10  89/02/26  10:55:08  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.9  88/12/19  02:56:05  mwyoung
 * 	Remove lint.
 * 	[88/12/17            mwyoung]
 * 
 * Revision 2.8  88/11/21  17:00:26  rvb
	...
	caddr_t reg;
{
	 ...
	 * with it's self-test, otherwise it won't autoconfig.
	 */
	...
	int unit;
{
	...
	splx( s );
#if	DLI
	dli_init(&qe_dlv[ifp->if_unit], ifp, sc->is_addr, etherbroadcastaddr,
