 ...
 * HISTORY
 * $Log:	ht.c,v $
 * Revision 2.8  89/03/09  22:29:08  rpd
 * 	More cleanup.
 * 
 * Revision 2.7  89/02/26  10:56:42  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.6  89/01/18  01:21:56  jsb
 * 	Include mach.h.
 * 	[89/01/17  11:02:24  jsb]
 * 
 * Revision 2.5  88/08/24  03:06:52  mwyoung
 * 	Corrected include file references.
 * 	[88/08/22  22:08:19  mwyoung]
 * 
 *
 * 12-Jun-88  Michael Young (mwyoung) at Carnegie-Mellon University
 *	MACH: Don't include "sys/cmap.h".
 *
 * 22-Apr-88  Mike Accetta (mja) at Carnegie-Mellon University
 *	CMUCS: Add include of "sys/proc.h" to support controlling tty
 *	fields which have been moved to this structure.
 *	[ V5.1(XF23) ]
 *
 * 18-Mar-88  Robert Baron (rvb) at Carnegie-Mellon University
 *	Fix H_1600BPI to be 010 vs 08.  gcc does not like the latter.
 *
 * 09-Jun-86  Mike Accetta (mja) at Carnegie-Mellon University
 *	CS_GENERTIC:  Added 6250 BPI initialization in htopen() (for
 *	SI TU45 emulation interface).
 *
 */
/*
