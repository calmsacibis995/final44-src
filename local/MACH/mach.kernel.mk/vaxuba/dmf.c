 ...
 * HISTORY
 * $Log:	dmf.c,v $
 * Revision 2.3  89/03/09  22:32:00  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/26  11:00:21  gm0w
 * 	Changed CMUCS_TTYLOC to CMUCS
 * 	[89/02/23            mrt]
 * 
 ...
 *
 * 04-Oct-83  Mike Accetta (mja) at Carnegie-Mellon University
 *	CS_TTYLOC:  Added setting of terminal location in dmfopen()
 *	(V3.07f).
 *
 */
/*
...
#ifdef	CMUCS
int	ndmf = NDMF*8;			/* used by iostat and ttyloc */
#else	CMUCS
#ifndef	lint
