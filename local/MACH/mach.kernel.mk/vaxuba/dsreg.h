 ...
 * HISTORY
 * $Log:	dsreg.h,v $
 * Revision 2.3  89/03/09  22:33:53  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/26  11:02:23  gm0w
 * 	Updated copyright.
 * 	[89/02/23            gm0w]
 * 
 */
...
#define ASC_HZ3	(0)		/* filter, 3.2kHz */
#define ASC_HZ6	bit(1)		/* filter, 6.4kHz */
#define ASC_BYPASS	bit(2)		/* external filter */
#define ASC_HZ20	(bit(1)|bit(2))	/* filter, 20kHz */
