 ...
 * HISTORY
 * $Log:	tmscp.c,v $
 * Revision 2.5  89/03/09  22:39:27  rpd
 * 	More cleanup.
 * 
 * Revision 2.4  89/02/26  11:08:35  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.3  88/07/15  16:16:19  mja
 * 	ULTRIX_TMSCP:  Added conditional to pick up the ULTRIX version
 * 	of the driver;  corrected includes and simplified local
 * 	conditionals.
 * 
...
#include <ultrix_tmscp.h>
#if	ULTRIX_TMSCP
#include <ultrix/tmscp.c>
#else	ULTRIX_TMSCP
