 ...
 * HISTORY
 * $Log:	tsreg.h,v $
 * Revision 2.3  89/03/09  22:39:59  rpd
 * 	More cleanup.
 * 
 * Revision 2.2  89/02/26  11:09:04  gm0w
 * 	Changes for cleanup.
 * 
 * 30-May-87  Mike Accetta (mja) at Carnegie-Mellon University
 *	CMUCS: fix b_repcnt and b_command macro definitions to match
 *	spacing in other similar files and avoid redefinition errors
 *	from CPP.
 *	[ V5.1(XF11) ]
 *
 */
