 ...
 * HISTORY
 * $Log:	nw_mk.h,v $
 * Revision 2.3  93/12/23  17:00:43  dbg
 * 	Fixed declarations of mk_slow_sweep, mk_fast_sweep,
 * 	mk_return.
 * 	[93/12/23            dbg]
 * 
...
extern no_return mk_return(void);

extern boolean_t mk_deliver_result(thread_t thread, int result);

extern void mk_fast_sweep();

extern void mk_slow_sweep();
