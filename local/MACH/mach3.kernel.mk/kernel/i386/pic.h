 ...
 * HISTORY
 * $Log:	pic.h,v $
 * Revision 2.12  93/11/17  16:38:30  dbg
 * 	Added definitions for MASTER_ICW, MASTER_OCW, SLAVE_ICW,
 * 	SLAVE_OCW, since these are constant for a configuration
 * 	(and common to both ISA and MCA machines).  Corrected
 * 	definitions of OCW2 operation codes.
 * 	[93/10/29            dbg]
 * 
 ...
 * 	Flush stuff that belongs in pic.c -- undo damage of Prime merge.
 * 	[89/10/20            rvb]
 * 
...
#define	SLAVE_ICW	(ADDR_PIC_BASE + SIZE_PIC + OFF_ICW)
#define	SLAVE_OCW	(ADDR_PIC_BASE + SIZE_PIC + OFF_OCW)
