 ...
 * HISTORY
 * $Log:	trap.c,v $
 * Revision 2.25  94/12/15  15:26:10  dbg
 * 	Set regs->cr2 in kernel_trap and user_trap.  Locore doesn`t save
 * 	it any more.
 * 	[94/09/22            dbg]
 * 
 * 	Use kernel write protection if processor supports it.
 * 	[94/01/09            dbg]
 * 
