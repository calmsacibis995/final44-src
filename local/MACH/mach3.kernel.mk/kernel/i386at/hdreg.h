 ...
 * HISTORY
 * $Log:	hdreg.h,v $
 * Revision 2.8  94/12/15  15:40:15  dbg
 * 	Removed definitions that are found in device/pc_disk.h.
 * 	[94/02/21            dbg]
 * 
...
#ifndef	_I386AT_HDREG_H_
#define	_I386AT_HDREG_H_
