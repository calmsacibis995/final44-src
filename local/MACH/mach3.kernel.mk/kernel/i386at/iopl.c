 ...
 * HISTORY
 * $Log:	iopl.c,v $
 * Revision 2.12  93/11/17  16:49:53  dbg
 ...
 * 	[93/05/14            dbg]
 * 
 * Revision 2.11  93/09/01  11:32:49  mrt
 * 	For X11R5, allow any old address to be mmapped.
 * 	[93/08/19            rvb]
 * 
 * Revision 2.10  93/03/09  11:18:43  danner
 ...
 * 	[93/03/03            rvb]
 * 
 * Revision 2.9  92/04/03  12:09:07  rpd
	...
	vm_prot_t	prot)
{
	...
	if (off == 0)
		...
		return -1;
	else if (off >= 0x100000 && off <= last_addr)
		return -1;
	else
		return off;
    }
	...
	/* Get physical address for the page to be mapped. */
