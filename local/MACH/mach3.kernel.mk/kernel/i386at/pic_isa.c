 ...
 * HISTORY
 * $Log:	pic_isa.c,v $
 * Revision 2.6  94/12/15  15:45:07  dbg
 * 	All devices now set up their own interrupts except
 * 	for fpintr.  Zero all other entries.  This is also
 * 	used by MCA code.
 * 	[94/06/15            dbg]
 * 
