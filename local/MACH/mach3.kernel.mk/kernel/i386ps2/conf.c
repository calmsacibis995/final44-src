 ...
 * HISTORY
 * $Log:	conf.c,v $
 * Revision 2.6  94/12/15  15:46:02  dbg
 * 	Moved pos_init, pos_slot here from i386ps2/autoconf.c, since we
 * 	are using a common autoconf.  Removed MC and PIT clock devices
 * 	for RT-Mach merge.
 * 	[94/06/17            dbg]
 * 
...
extern int	comgetstat(), comsetstat();
#define	comname			"com"
#endif	/* NCOM > 0 */
 ...
 * its slot number. We are given the initial slot number
