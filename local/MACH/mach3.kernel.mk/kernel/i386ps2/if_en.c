 ...
 * HISTORY
 * $Log:	if_en.c,v $
 * Revision 2.3  94/12/15  15:47:19  dbg
...
boolean_t enprobe(vm_offset_t, struct bus_device *);
void	  enattach(struct bus_device *);
int	  enintr(int unit);
...
struct bus_driver endriver = {
	enprobe, 0, enattach, 0, 0, "en", eninfo, 0, 0, 0 };

int (*enintrs[])() = { enintr, 0 };
