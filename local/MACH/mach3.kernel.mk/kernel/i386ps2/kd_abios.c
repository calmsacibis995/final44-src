 ...
 * HISTORY
 * $Log:	kd_abios.c,v $
 * Revision 2.3  94/12/15  15:48:19  dbg
 * 	Made compile as a separate file.
 * 	[94/06/20            dbg]
 * 
...
void kdabios_init(void)
{
    ...
    {
#if 0
	/* KDATTACH has already done this! */
	struct bus_device kd_dev;

	kd_dev.unit = 0;
	kd_dev.intr = kdintr;
	kd_dev.irq = kreq[1].r_hardware_intr;
	kd_dev.priority = SPL6;
