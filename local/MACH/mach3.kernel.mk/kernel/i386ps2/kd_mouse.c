 ...
 * HISTORY
 * $Log:	kd_mouse.c,v $
 * Revision 2.5  94/12/15  15:48:34  dbg
 * 	Use tod_clock, kern/mach_clock.h.
 * 	[94/06/15            dbg]
 * 
...
static int mouse_setup(void)
{
    ...
    {
	struct bus_device ms_dev;

	ms_dev.unit = 0;
	ms_dev.intr = mouseintr;
	ms_dev.irq = mouserb.r_hardware_intr;
	ms_dev.priority = SPLTTY;
...
void mouse_button(kev_type which, int up)
{
	kd_event ev;
	timespec_t	cur_time;
