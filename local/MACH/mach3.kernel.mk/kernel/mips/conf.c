 ...
 * HISTORY
 * $Log:	conf.c,v $
 * Revision 2.23  94/12/16  11:04:18  dbg
 * 	RT-Mach merge: clocks are not devices.
 * 	[94/06/22            dbg]
 * 
 * 	Removed use of port_death routines.
 * 	[94/02/23            dbg]
 * 
...
io_return_t	cons_open(),cons_close(),cons_read(),cons_write(),
		cons_get_status(), cons_set_status();
