 ...
 * HISTORY
 * $Log:	thread.h,v $
 * Revision 2.9  93/11/17  17:56:10  dbg
 * 	Added INTERRUPTED_PC for PC sampling.
 * 	[93/10/14            dbg]
 * 
...
#define	INTERRUPTED_PC(thread)	(USER_REGS(thread)->pc)

/*
 *	Definitions of routines that must be defined
 *	in all machines are now in kern/thread.h.
 */
