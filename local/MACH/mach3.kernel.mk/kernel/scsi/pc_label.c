 ...
 * HISTORY
 * $Log:	pc_label.c,v $
 * Revision 2.3  94/12/16  11:31:15  dbg
 * 	Include device/pc_disk.h for PC-compatible label structures.
 * 	[94/02/21            dbg]
 * 
	...
	
{
	...
	label->d_npartitions = nparts;		/* up to 'c' */
