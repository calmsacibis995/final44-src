 ...
 * HISTORY
 * $Log:	rz_audio.c,v $
 * Revision 2.6  93/05/15  19:42:03  mrt
 * 	machparam.h -> machspl.h
 * 
 * Revision 2.5  93/05/10  21:22:22  rvb
...
private void zero_ior( io_req_t );
	...
	io_req_t	req)
{
	...
	/*
	 * Allocate dynamic data ifnot
	 */
	if (tgt->dev_info.cdrom.result == 0) {
		if (kmem_alloc(kernel_map, &tgt->dev_info.cdrom.result,
