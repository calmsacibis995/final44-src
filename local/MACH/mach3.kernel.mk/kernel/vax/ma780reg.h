...
struct mpm_regs
{
	u_int	mpm_csr;		/* configuration register */
	u_int	mpm_cr;			/* control register */
	u_int	mpm_sr;			/* controller status register */
	u_int	mpm_invld;		/* invalidation control register */
	u_int	mpm_err;		/* array error register */
	u_int	mpm_sr0;		/* configuration status register 0 */
	u_int	mpm_sr1;		/* configuration status register 1 */
	u_int	mpm_maint;		/* maintainance control register */
	u_int	mpm_ir;			/* interrupt request/status */
	u_int	mpm_en;			/* interrupt enable/status */
} ;
