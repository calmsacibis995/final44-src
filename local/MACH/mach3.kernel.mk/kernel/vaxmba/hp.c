 ...
 * HISTORY
 * $Log:	hp.c,v $
 * Revision 2.3  92/02/23  22:45:48  elf
 * 	Added hpgetstat(), commented out hpioctl.
 * 	[92/02/22  18:59:41  af]
 * 
 * Revision 2.2  90/08/27  22:14:28  dbg
 ...
 * 	[88/08/29            dbg]
 * 
 * Revision 2.1  89/08/03  16:40:22  rwd
 * Created.
 * 
 * Revision 2.3  88/08/24  03:06:19  mwyoung
 * 	Corrected include file references.
 * 	[88/08/22  22:08:03  mwyoung]
 * 
 *
 * 15-Mar-88  Robert Baron (rvb) at Carnegie-Mellon University
 *	Created CS_DISK for changes to <foo>_sizes used by CMU CS.
 *	When it is off, you should get a vanilla 4.3bsd disk layout.
 *
 * 27-Aug-87  Robert Baron (rvb) at Carnegie-Mellon University
 *	For now, on wb1 catch DISK IO attempted by a slave processor,
 *	since there is not a common IO bus.  This changes should be
 *	removed someday.
 *
 ...
 *	CS_DISK: Upgraded from 4.1BSD.  Retained local partition
 ...
 * than maxdist and more than mindist sectors "before" our desired sector.
 ...
 * Get status routine
 */
hpgetstat(dev, flavor, status, count)
	dev_t	dev;
	int	*status, *count;
{
	register int unit, xunit;
