 ...
 * HISTORY
 * $Log:	qduser.h,v $
 * Revision 2.2  91/05/08  13:32:51  dbg
 * 	Added volatile declarations.
 * 	[91/04/19            dbg]
 * 
 * Revision 2.1  89/08/03  16:43:41  rwd
 * Created.
 * 
 * Revision 2.2  89/02/26  11:06:37  gm0w
 * 	Updated copyright.
 * 	[89/02/23            gm0w]
 * 
 */
...
#ifndef	_VAXUBA_QDUSER_H_
#define	_VAXUBA_QDUSER_H_
...
#define CURS_MIN_Y 	15	/* device coordinate y = 0 */
...
/* DMA request queue is a ring buffer of request structures */
  ...
  volatile  short status;	    /* master DMA status word */
