 ...
 * HISTORY
 * $Log:	qvfont.c,v $
 * Revision 2.1  89/08/03  16:42:00  rwd
 * Created.
 * 
 * Revision 2.4  89/02/26  11:07:09  gm0w
 * 	Changes for cleanup.
 * 
 * Revision 2.3  88/08/24  03:07:59  mwyoung
 * 	Corrected include file references.
 * 	[88/08/22  22:08:34  mwyoung]
 * 
 *
 * 22-Apr-87  Mike Accetta (mja) at Carnegie-Mellon University
 *	CS_GENERIC: converted conditionals to flush CS_QVSS symbol.
 *	NQV,NQD: conditionalized for inclusion with either option.
 *	[ V5.1(F10) ]
 *
 */
/*
 *	@(#)qvfont.c	1.4 (ULTRIX) 4/24/85
 *
 */
...
#ifdef	MACH
	,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,'`'  ,0x82 /*  80 */
#else	MACH
...
#ifdef	MACH
	,0x00 ,0x00 ,0x00 ,0x00 ,0x7f ,'\r' ,0x09 ,0x1b /* 184 */
#else	MACH
