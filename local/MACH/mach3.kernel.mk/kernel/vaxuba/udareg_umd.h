 ...
 * HISTORY
 * $Log:	udareg_umd.h,v $
 * Revision 2.2  91/05/08  13:34:38  dbg
 * 	Add volatile declarations.
 * 	[91/04/16            dbg]
 * 
 * Revision 2.1  89/08/03  16:42:51  rwd
 * Created.
 * 
 ...
 */
struct udadevice {
	volatile u_short udaip;		/* initialisation and polling */
	volatile u_short udasa;		/* status and address */
};
#if	NBI > 0
 
struct kdb50device {
	struct udadevice kdb50_uda;
	volatile short	 kdb50_wr;	/* write register (KDB50) */
};
