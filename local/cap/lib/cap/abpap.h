/*
 *  Author: cck    Date: 88/02/22 09:33:19  
 *  Header: abpap.h,v 1.10 88/02/22 09:33:19 cck Rel  
 *  Revision: 1.10  
*/
...
#define NUMPAP 2		/* 2 connections allowed at once */

#define NUMSPAP 1		/* Number of servers allowed */
