/*
 *  Author: cck    Date: 88/05/13 09:25:58  
 *  Header: afpcmd.h,v 1.7 88/05/13 09:25:58 cck Rel  
 *  Revision: 1.7  
*/
...
typedef struct {
  ...
  word sr_flags;		/* flags */
#define SupportsFPCopyFile 0x01	/* can do an copyfile */
...
#define OFK_MRDX 0x08			/* exclusive read mode */
#define OFK_MWRX 0x10			/* exclusive write mode */
