...
/*---------------------------------------------------------------------------
 * Routine:	initgraph ( res )
 *
 * Results:	none.
 *
 * Side Efct:	initializes linethickness and linmod
 *
 * (This routine added by DD so that linethickness could reflect the
 *  resolution)
 *---------------------------------------------------------------------------*/
...
register int res;
{
	linethickness = 0.008 * res;

	/* make linethickness odd, and also	*/
	/* insure it is nonzero...		*/
	linethickness |= 1;
