/*
 *  $Id: krt_rt_sock.c,v 1.23.2.11 1995/06/06 15:13:57 jch Exp $
 */
		  ...
		  router, sockaddr_un *)
{
    ...
    flag_t flags = 0;
    size_t size = sizeof *rtp + s_dest->sa_len;
		     ...
		     adip, krt_addrinfo *)
{
    ...
    if (mc) {
	if (!rtp->rtm_errno) {
#if	!defined(KRT_IPMULTI_RTSOCK) || defined(KRT_IPMULTI_TTL0)
	    krt_multicast_change(rtp->rtm_type, &rtparms);
	}
#endif	/* !defined(KRT_IPMULTI_RTSOCK) || defined(KRT_IPMULTI_TTL0) */
	return;
    }
#endif	/* IP_MULTICAST */
