/* 
 * $Id: rk_krb.c,v 1.3 1993/12/23 16:46:21 dglo Exp dglo $
 * $Source: /a/guest/dglo/nuk/librkinit/RCS/rk_krb.c,v $
 * $Author: dglo $
 *
...
static char *rcsid = "$Id: rk_krb.c,v 1.3 1993/12/23 16:46:21 dglo Exp dglo $";
