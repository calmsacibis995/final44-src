/* 
 * $Id: rk_util.c,v 1.2 1993/12/14 22:11:29 dglo Exp dglo $
 * $Source: /a/guest/dglo/nuk/librkinit/RCS/rk_util.c,v $
 * $Author: dglo $
 *
...
static char *rcsid = "$Id: rk_util.c,v 1.2 1993/12/14 22:11:29 dglo Exp dglo $";
