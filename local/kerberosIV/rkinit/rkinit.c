/* 
 * $Id: rkinit.c,v 1.3 1993/12/23 16:40:59 dglo Exp dglo $
 * $Source: /a/guest/dglo/nuk/rkinit/RCS/rkinit.c,v $
 * $Author: dglo $
 *
...
static char *rcsid = "$Id: rkinit.c,v 1.3 1993/12/23 16:40:59 dglo Exp dglo $";
