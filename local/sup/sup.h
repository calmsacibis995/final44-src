 ...
 **********************************************************************
 * HISTORY
 * 17-Sept-90  Mary Thompson (mrt) at Carnegie-Mellon University
 *       Added DEBUGFPORTNUM define for places where supfiledbg is
 *       not it /etc/services.
 *
 *  5-Apr-90  Mary Thompson (mrt) at Carnegie-Mellon University
 *	Changed so that last and when file names would include
