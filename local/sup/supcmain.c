 ...
 **********************************************************************
 * HISTORY
 * 20-Sep-90  Robert Baron (rvb) at Carnegie Mellon
 *	Changed usages of sprintf to be cast to void and always
 *	get it return value from the parameter. This is to be
 *	consistent with CMU, BSD and SunOS versions of sprintf
 *
