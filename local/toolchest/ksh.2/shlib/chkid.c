 ...
 *
 ==== BSD - allow ANYTHING for a name.  Some things just don't
 ==== work because of parsing order; but the rules stated below
 ==== are unnecessarily restrictive and result in perfectly
 ==== reasonable names being rejected as invalid for no justifiable
 ==== reason.
