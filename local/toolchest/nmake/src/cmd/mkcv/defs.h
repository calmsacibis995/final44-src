 ...
 */
/*	@(#)defs.h	1.2 of 3/28/83	*/
#include <stdio.h>
#include <sys/types.h>	/* MKCV */
#include <sys/stat.h>	/* MKCV */
#include <directory.h>	/* MKCV */
#include <generic.h>	/* MKCV */

#define VOID	int	/* MKCV */
#if MKCV /* MKCV */
#define system(buf) docom1(buf,0,0)
#endif /* MKCV */
...
extern VOID (*sigivalue)();	/* MKCV */
extern VOID (*sigqvalue)();	/* MKCV */
extern int waitpid;
extern int ndocoms;
extern int okdel;
