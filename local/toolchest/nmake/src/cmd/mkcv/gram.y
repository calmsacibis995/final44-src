...
deplist:	= { fatal1("Must be a separator on rules line %d", yyline); }
	| dlist
	;
 ...
 *	file name and the old current lineno, generally, yyline.
 */
...
GETC()
{
	...
	{
		fclose(fin);
		yyline = sfiles[--morefiles].syylno;
