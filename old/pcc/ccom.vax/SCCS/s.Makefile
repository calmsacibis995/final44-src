h31359
s 00002/00003/00035
d D 1.27 90/06/18 13:55:39 bostic 28 27
c don't use yacc temporary
e
s 00007/00010/00031
d D 1.26 90/06/18 11:46:20 bostic 27 26
c localdefs.h -> pcc/mip, use .IMPSRC instead of specifying
e
s 00000/00003/00041
d D 1.25 90/06/17 16:50:20 bostic 26 25
c don't need .c->.o rule
e
s 00033/00192/00011
d D 1.24 90/06/17 14:35:13 bostic 25 24
c pmake style; break up into pcc subdirectories
e
s 00002/00000/00201
d D 1.23 90/06/08 14:54:09 bostic 24 23
c add obj target
e
s 00002/00001/00199
d D 1.22 90/02/20 11:34:33 bostic 23 22
c new yacc has different yyfix commands
e
s 00002/00002/00198
d D 1.21 89/08/15 20:28:20 bostic 22 21
c reorg
e
s 00003/00003/00197
d D 1.20 89/05/11 14:34:56 bostic 21 20
c file reorg, pathnames.h, paths.h
e
s 00003/00000/00197
d D 1.19 89/03/06 08:46:37 bostic 20 19
c cleanup, add cleandir
e
s 00004/00004/00193
d D 1.18 88/09/22 16:56:11 bostic 19 18
c rel.o duplicated, already in ${OBJS}
e
s 00010/00015/00187
...
I 25
D 27
table.o: ${.CURDIR}/${.PREFIX}.c
	${CC} ${CFLAGS} -c -R ${.CURDIR}/${.PREFIX}.c
E 25
...
E 25
I 25
pcclocal.h: ${.CURDIR}/localdefs.h /usr/include/pcc.h
E 27
I 27
...
I 21
	...
	install -s -o bin -g bin -m 755 ${TESTDIR}/sccom ${DESTDIR}/usr/libexec
	install -s -o bin -g bin -m 755 ${TESTDIR}/f1 ${DESTDIR}/usr/libexec
E 25
I 25
D 27
pcctokens: ${.CURDIR}/localdefs.h /usr/include/pcc.h
E 27
I 27
