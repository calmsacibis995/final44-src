h61885
s 00001/00001/00008
d D 1.31 91/11/14 09:59:01 bostic 35 34
c move  lint to /usr/old
e
s 00000/00001/00009
d D 1.30 90/06/08 14:09:19 bostic 34 33
c don't need bsd.own.mk
e
s 00007/00124/00003
d D 1.29 90/06/05 14:33:10 bostic 33 32
c break up programs/libraries into separate directories, use pmake
e
s 00002/00001/00125
d D 1.28 90/02/21 10:21:25 bostic 32 31
c new yacc has different yyfix command
e
s 00002/00001/00124
d D 1.27 89/08/24 19:26:56 bostic 31 30
c rename to something obvious
e
s 00008/00008/00117
d D 1.26 89/08/24 19:19:12 bostic 30 29
c cpp -> /usr/bin
e
s 00003/00003/00122
d D 1.25 89/05/19 18:55:54 bostic 29 28
c put in subdirectory of /usr/libdata
e
s 00007/00008/00118
d D 1.24 89/05/10 22:28:10 bostic 28 27
c file reorg, pathnames.h, paths.h
e
s 00001/00001/00125
d D 1.23 89/02/06 17:29:00 bostic 27 26
c don't need a for loop
e
s 00009/00004/00117
d D 1.22 88/10/25 18:25:50 bostic 26 25
c add man page
e
s 00002/00002/00119
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-port | ./lpass1 -puv > llib-port.ln )
E 30
I 6
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-ldbm | ./lpass1 -uv > llib-ldbm.ln )
E 30
E 14
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-lm | ./lpass1 -uv > llib-lm.ln )
E 30
E 14
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-lmp | ./lpass1 -uv > llib-lmp.ln )
E 30
E 14
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-lplot | ./lpass1 -uv > llib-lplot.ln )
E 30
E 14
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-ltermcap | ./lpass1 -uv > llib-ltermcap.ln )
E 30
E 14
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint llib-lc | ./lpass1 -v > llib-lc.ln )
E 30
I 8
...
E 30
I 30
	-(/usr/bin/cpp -C -Dlint -D__void__=__curses__ llib-lcurses | ./lpass1 -v > llib-lcurses.ln )
E 30
E 17
E 8
D 6
...
E 31
I 31
	install -s -o bin -g bin -m 755 lpass1 /usr/libexec/lintpass1
	install -s -o bin -g bin -m 755 lpass2 /usr/libexec/lintpass2
E 31
...
E 29
I 29
	rm -f /usr/libdata/lint/llib-ltermlib*
	ln -s llib-ltermcap /usr/libdata/lint/llib-ltermlib
	ln -s llib-ltermcap.ln /usr/libdata/lint/llib-ltermlib.ln
E 29
E 28
E 13
E 11
