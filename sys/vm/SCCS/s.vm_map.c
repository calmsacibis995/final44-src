h08704
s 00009/00006/02613
d D 8.9 95/05/17 11:42:02 pendry 20 19
c drain, deallocate and unlock map in vm_map_deallocate
e
s 00005/00005/02614
d D 8.8 95/05/14 00:36:57 mckusick 19 18
c lock manager is back to taking a proc rather than a pid
e
s 00001/00001/02618
d D 8.7 95/05/11 14:52:13 mckusick 18 17
c lock_init => lockinit
e
s 00008/00005/02611
d D 8.6 95/04/27 14:48:03 mckusick 17 16
c lockmanager takes an interlock and a pid rather than a proc ptr
e
s 00014/00015/02602
d D 8.5 95/04/12 17:22:07 mckusick 16 14
c redefine lock_* calls to use lockmgr
e
s 00014/00015/02602
d R 8.5 95/04/12 14:29:48 mckusick 15 14
c redefine lock_* calls to use lockmgr
e
s 00036/00019/02581
d D 8.4 95/01/09 17:46:40 cgd 14 13
c style, 64-bit safety, and check for NULL _before_ the dereference.
e
s 00119/00013/02481
d D 8.3 94/01/12 15:58:09 hibler 13 12
c new vm_map_clean routine to do bulk of msync,
c "special" maps now have entries_pagable == FALSE.
e
s 00001/00001/02493
d D 8.2 94/01/04 22:22:56 bostic 12 11
c lint
e
s 00002/00002/02492
d D 8.1 93/06/11 16:37:47 bostic 11 10
c 4.4BSD snapshot (revision 8.1); add 1993 to copyright
e
s 00047/00019/02447
d D 7.10 93/06/02 11:12:10 hibler 10 9
c fix up vm_map_pageable for mlock/munlock (changes from Mach 3.0) 
c mostly checks for unallocated pages in range
e
s 00002/00002/02464
d D 7.9 93/05/24 23:40:37 torek 9 8
c pedantically ANSI, i.e., nothing after #else/#endif
e
s 00025/00002/02441
d D 7.8 93/03/09 10:58:14 hibler 8 7
c attempt to recover from vm_fault_wire failure in vm_map_pageable
e
s 00006/00004/02437
d D 7.7 93/03/02 16:48:50 mckusick 7 6
c avoid sleeps in page daemon calls to vm_map_entry_create (net2/sys/18)
e
s 00022/00008/02419
d D 7.6 92/05/04 17:24:33 bostic 6 5
c new include format; lint; function prototypes
e
s 00060/00079/02367
d D 7.5 92/02/19 18:46:08 torek 5 4
c split vm_map_findspace out of vm_map_find
e
s 00001/00001/02445
d D 7.4 91/08/28 15:46:44 mckusick 4 3
c internal bit field replaced with flag
e
s 00027/00004/02419
d D 7.3 91/04/21 18:36:11 mckusick 3 2
c update to new CMU copyright and distribution terms
e
s 00110/00054/02313
d D 7.2 91/04/20 10:48:41 karels 2 1
c fix includes; new proc struct; rm *_NULL;
c rename vm_map_init to _startup; add vmspace struct, functions (more to come)
e
s 02367/00000/00000
d D 7.1 90/12/05 18:08:03 mckusick 1 0
